...
// req.send("https://www.ambitiouskitchen.com/best-cinnamon-rolls/");
...
//   //mogoose save, only take data i need
// });
...
axios.request(options).then(function (response) {
  ...
  //pick apart res.data for specific wanted info,
  //insert mongodb
  let name = response.data[0].name;
  let description = response.data[0].description;
  let ingredients = response.data[0].ingredients;
  let instructions = response.data[0].instructions[0].steps;
...
//  dp.recipes.insert({
//    name: "The Best Cinnamon Rolls You'll Ever Eat",
//    description: "The BEST cinnamon rolls in the WORLD. Big, fluffy, soft and absolutely delicious. You'll never go back to any other recipe once you try this one! This cinnamon roll recipe includes options to make them overnight or ahead of time and even freeze them.",
//    ingredients: [
//     'For the dough:',
...
//   ],
//    images: [
//     'https://www.ambitiouskitchen.com/wp-content/uploads/2017/05/Monique-Cinnamon-Rolls-1.jpg',
//     'https://www.ambitiouskitchen.com/wp-content/uploads/2017/05/Monique-Cinnamon-Rolls-1-500x500.jpg',
//     'https://www.ambitiouskitchen.com/wp-content/uploads/2017/05/Monique-Cinnamon-Rolls-1-500x375.jpg',
//     'https://www.ambitiouskitchen.com/wp-content/uploads/2017/05/Monique-Cinnamon-Rolls-1-480x270.jpg'
//   ]
//  })